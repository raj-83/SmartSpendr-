...
const TransactionTable = ({ transactions }) => {
  ...
  const filteredAndSortedTransactions = useMemo(() => {
    console.log("running filteredandsortedtranscationsaction");
    let result = [...transactions];

    console.log("the value of searchTerm is ", searchTerm);
    // setRecurringFilter('recurring');
    console.log("the value of recurring is ", recurringFilter);



    if (searchTerm) {
      const searchLower = searchTerm.toLowerCase();
      console.log("the result inside if condition of searchTerm is searchLower ", searchLower);
    ...
    console.log('the result before recurring is ', result);
    if (recurringFilter) {
      result = result.filter((transaction) => {
        if (recurringFilter === "recurring") return transaction.isRecurring;
        return !transaction.isRecurring;
      });
      console.log('the result after recurring is ', result);
    }



    // Apply type filter
    console.log('the result befor type filter', result)

    if (typeFilter) {
      console.log('The value of type filter', typeFilter)
      result = result.filter((transaction) => transaction.type.toLowerCase() == typeFilter.toLocaleLowerCase()

      );
    }
    console.log('the result after type filter', result)
